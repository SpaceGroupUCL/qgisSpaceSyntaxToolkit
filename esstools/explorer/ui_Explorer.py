...
# Form implementation generated from reading ui file '/Users/jorge/Dropbox/UCL/Development/C_Implementation/esstools/explorer/ui_Explorer.ui'
#
# Created: Sun Aug 24 12:33:03 2014
...
class Ui_ExplorerDialog(object):
    def setupUi(self, ExplorerDialog):
        ...
        self.explorerSplitter = QtGui.QSplitter(self.explorerLayout)
        self.explorerSplitter.setOrientation(QtCore.Qt.Vertical)
        self.explorerSplitter.setObjectName(_fromUtf8("explorerSplitter"))
        self.widget = QtGui.QWidget(self.explorerSplitter)
        ...
        self.attributesLayout.addWidget(self.layerCombo)
        ...
        self.attributesLayout.setStretch(2, 2)
        self.explorerTabs = QtGui.QTabWidget(self.explorerSplitter)
        ...
        self.verticalLayout.addWidget(self.explorerSplitter)
