...
class Node(QtCore.QObject):
    ...
    def dependentNodes(self):
        ...
        nodes = set()
        for t in list(self.inputs().values()):
    ...
    def inputValues(self):
        ...
        vals = {}
        for n, t in list(self.inputs().items()):
            vals[n] = t.value()
        return vals
    ...
    def outputValues(self):
        ...
        vals = {}
        for n, t in list(self.outputs().items()):
            vals[n] = t.value()
        return vals
    ...
    def saveTerminals(self):
        terms = OrderedDict()
        for n, t in list(self.terminals.items()):
            terms[n] = (t.saveState())
        return terms
    ...
    def restoreTerminals(self, state):
        ...
        for name, opts in list(state.items()):
...
class NodeGraphicsItem(GraphicsObject):
    ...
    def itemChange(self, change, val):
        if change == self.ItemPositionHasChanged:
            for k, t in list(self.terminals.items()):
                t[1].nodeMoved()
