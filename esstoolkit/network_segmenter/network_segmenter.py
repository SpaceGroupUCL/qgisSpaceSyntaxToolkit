...
class NetworkSegmenter(object):
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&NetworkSegmenter')
        ...
        # Create the tool module (after translation) and keep reference
        self.network_segmenter_tool = network_segmenter_tool.NetworkSegmenterTool(self.iface)
