...
<qgis version="2.16.0-Nødebo" simplifyAlgorithm="0" minimumScale="100000" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="F_Type" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="Blank" label="Blank"/>
      <category render="true" symbol="1" value="High Opaque Fence" label="High Opaque Fence"/>
      <category render="true" symbol="2" value="High See Through Fence" label="High See Through Fence"/>
      <category render="true" symbol="3" value="Low Fence" label="Low Fence"/>
      <category render="true" symbol="4" value="Semi Transparent" label="Semi Transparent"/>
      <category render="true" symbol="5" value="Transparent" label="Transparent"/>
    </categories>
    <symbols>
